...
return Object.defineProperty(t,"__esModule",{value:!0}),t}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}})),runningTests||require("replace-query-param-repro/app").default.create({name:"replace-query-param-repro",version:"0.0.0+14380b61"})
